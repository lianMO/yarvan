...
else
{
	...
	$mysql = new MySQL();
	$data = $mysql->getServAppoint($page);
	$count = $mysql->getServAppointCount();
	$i=0;
?>
<!DOCTYPE html>
				...
				<div class="span9">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							while(isset($data[$i]))
							{
							echo "<tr><td>".$data[$i]['id']."</td><td>".$data[$i]['user']."</td><td>".$data[$i]['identity_card']."</td>";
							...
							echo "<tr><td colspan='8'></td></tr>";
								if($count<=10)
								{
									echo "<tr><td colspan='8'><a href = 'center_appoint.php'>首页</a>&nbsp;<a  href='?page=".$page."'>".$page."</a>&nbsp;<a href = 'center_appoint.php' >尾页</a></td></tr>";
								}
								else 
								{
									echo "<tr><td>";
								   echo "<a href = 'center_appoint.php'>首页</a>&nbsp;";
								   if($page>1)
								   {
